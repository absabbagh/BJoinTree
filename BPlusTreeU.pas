...
type
  ...
  BtrPlusClass = class(TFileStream)
    ...
    public
      constructor Create(FileName: string; IsOpen: Boolean;
...
constructor BtrPlusClass.Create(FileName: string; IsOpen: Boolean;
                                const TheKeys: array of string;
                                const ASC: array of boolean;
                                const TheInheritedKeys: array of string;
...
begin
  ...
  if IsOpen then
    begin
      ...
      inherited Create(FileName,Params);
    end else
    begin
      if FOK then
        begin
...
begin
  ...
  create(FileName, IsOpen, TheKeys, ASC, TheInheritedKeys, ANumberOfDataRef);
end;
...
begin
  ...
  if Control then // There is space in the node
    ...
    begin // Split node
      ...
      // Note: V1 must be either node.Km or V
