...
3 : begin
         // source: expr.y line#47
         writecallback(yyv[yysp-1].yyReal); 
       end;
4 : begin
         // source: expr.y line#48
         x[yyv[yysp-3].yyInteger] := yyv[yysp-1].yyReal; writecallback(yyv[yysp-1].yyReal); 
       end;
5 : begin
         // source: expr.y line#49
         yyerrok; 
       end;
6 : begin
         // source: expr.y line#52
         yyval.yyReal := yyv[yysp-2].yyReal + yyv[yysp-0].yyReal; 
       end;
7 : begin
         // source: expr.y line#53
         yyval.yyReal := yyv[yysp-2].yyReal - yyv[yysp-0].yyReal; 
       end;
8 : begin
         // source: expr.y line#54
         yyval.yyReal := yyv[yysp-2].yyReal * yyv[yysp-0].yyReal; 
       end;
9 : begin
         // source: expr.y line#55
         yyval.yyReal := yyv[yysp-2].yyReal / yyv[yysp-0].yyReal; 
       end;
10 : begin
         // source: expr.y line#56
         yyval.yyReal := yyv[yysp-1].yyReal; 
       end;
11 : begin
         // source: expr.y line#57
         yyval.yyReal := -yyv[yysp-0].yyReal; 
       end;
12 : begin
         // source: expr.y line#59
         yyval.yyReal := yyv[yysp-0].yyReal; 
       end;
13 : begin
         // source: expr.y line#60
         yyval.yyReal := x[yyv[yysp-0].yyInteger]; 
       end;
// source: expr.cod line# 33
  end;
end(*yyaction*);
