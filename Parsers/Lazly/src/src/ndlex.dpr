...
begin
  ...
  FileExtension := ExtractFileExt(lfilename);
  FilePath := ExtractFileDir(lfilename) + DirectorySeparator;
  FileNameWithoutExtension := StringReplace(lfilename, FileExtension, EmptyStr, []);
